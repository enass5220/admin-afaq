...
if (!empty($searchTerm)) {
    try {
        ...
        $sql = "SELECT id, phone_number AS 'phone', full_name AS 'name', customer_code AS 'code' FROM users
                WHERE phone_number LIKE :searchTermPhone
                   OR customer_code LIKE :searchTermCode
                   OR full_name LIKE :searchTermName
        ...
        $stmt->bindValue(':searchTermName', $searchPattern, PDO::PARAM_STR);
