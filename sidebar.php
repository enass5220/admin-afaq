<nav class="sidebar sidebar-offcanvas" id="sidebar" style="direction: rtl;">
  <ul class="nav">
    <li class="nav-item">
    ...
    <li class="nav-item">
     ...
     <!--  <li class="nav-item">
      ...
      <div class="collapse" id="form-elements">
        <ul class="nav flex-column sub-menu">
          <li class="nav-item"><a class="nav-link" href="clients.php">الحسابات</a></li>
          <li class="nav-item"><a class="nav-link" href="transactions.php">المالية</a></li>
        </ul>
      </div>
    </li>
  <li class="nav-item">
